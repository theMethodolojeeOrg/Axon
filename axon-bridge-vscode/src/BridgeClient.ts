...
import { ConnectionProfile, ConnectionProfileManager } from './ConnectionProfileManager';
...
export class BridgeClient {
    ...
    /**
     * Connect using a saved connection profile's host/port/tls settings.
     */
    connectToProfile(profile: ConnectionProfile) {
        this.host = profile.host;
        this.port = profile.port;
        this.tlsEnabled = profile.tlsEnabled;
        this.connect();
        ConnectionProfileManager.markConnected(profile.id);
    }
