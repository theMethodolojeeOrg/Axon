    ...
    async start(): Promise<void> {
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                if (this.tlsEnabled) {
                    // TODO: Load TLS certificates from settings
                    // For now, generate self-signed cert
                    console.log('[AxonBridge Server] TLS not yet implemented, starting without TLS');
                }
                ...
                this.httpServer.listen(this.port, this.host, () => {
                    console.log(`[AxonBridge Server] Listening on ${this.host}:${this.port}`);
                    this.statusBar.setState('server_listening');
                    this.statusBar.showNotification(`Server listening on port ${this.port}`);
                    resolve();
                });
