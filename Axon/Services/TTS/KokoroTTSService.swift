...
enum KokoroTTSVoice: String, Codable, CaseIterable, Identifiable {
    ...
    var registryConfig: TTSVoiceConfig? {
        UnifiedModelRegistry.shared.voice(provider: .kokoro, voiceId: rawValue)
    }
    ...
    /// Description from registry, falling back to hardcoded value
    var registryDescription: String {
        registryConfig?.description ?? description
    }
