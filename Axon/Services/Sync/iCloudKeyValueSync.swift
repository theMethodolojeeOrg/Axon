...
struct SyncableSettings: Codable {
    ...
    var multiFileArtifactsEnabled: Bool?
    ...
    init(from settings: AppSettings) {
        ...
        self.multiFileArtifactsEnabled = settings.toolSettings.multiFileArtifactsEnabled
    ...
    func apply(to settings: inout AppSettings) {
        ...
        if let multiFileArtifactsEnabled {
            settings.toolSettings.multiFileArtifactsEnabled = multiFileArtifactsEnabled
        }
